...
const tools = ['toolTiktok', 'toolYoutube', 'toolSpotify', 'toolFacebook', 'toolCapcut', 'toolInstagram', 'toolFakelobby', 'toolFakedana', 'toolFakelobbyml', 'toolFakejago', 'toolPassword', 'toolLorem', 'toolQrcode', 'toolSertifikatlol', 'toolWrMLBB', 'toolEmojimix', 'toolBeritaMLBB', 'toolTiktokhashtag', 'toolTranslate', 'toolSpotifysearch', 'toolLyrics'];
...
},
{
        ...
        description: "Am Premium 1 tahun",
        price: "Rp 5.000",
...
function renderProducts() {
    ...
    productsGrid.innerHTML = products.map(product => {
        ...
        if (product.type === 'hot') {
            ...
            diskonClass = 'product-diskon';  // TAMBAHKAN INI
