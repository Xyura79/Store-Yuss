...
let products = [
{
    ...
    {
    id: 33,
    name: "Topup Diamond - Free Fire",
    description: "Topup diamond Free Fire dengan harga murah. Proses cepat & otomatis. Pilih jumlah diamond sesuai keinginan.",
    price: "Pilih Jumlah",
    image: "game/image/ff.jpg",
    category: "game",
    type: "none",
    isGameTopup: true,
    topupLink: "game/topup.html",
    benefits: [
    ...
    {
    id: 34,
    name: "Aplikasi Reaction WhatsApp",
    description: "Suntik Reaction Ke saluran WhatsApp Anda",
    price: 18000,
    image: "image/produk/produk34.jpg",
    category: "digital",
    isNegotiable: false,
    type: "new",
    downloadLink: "https://www.mediafire.com/file/zcq3ubyiz7qplqg/Reaction.apk/file",
    isApkOrderService: true,
    benefits: [
        "Pesan Saluran Whatsapp Full Reaction",
        "Bisa Jualan Reaction",
        "Aplikasi Bisa Di jual Lagi",
        "Mudah digunakan"
    ]
},
...
const autoSosmedServices = [
    /*{
        id: 1,
        kategori: 'whatsapp',
        name: "Pengikut Saluran WhatsApp V1",
        price: 80000,
        unit: "Pengikut",
        service_id: "226",
    ...
    unit: "Pengikut",
    service_id: "1285",
    description: "Tambahkan pengikut ke saluran WhatsApp - Fayupedia V2",
    minQuantity: 15,
    maxQuantity: 1000,
    placeholder: "https://whatsapp.com/channel/xxxxx",
    needLink: true,
...
},
{
    ...
    kategori: 'whatsapp',
    provider: 'fayupedia',
    name: "Pengikut Saluran WhatsApp V2",
    price: 70000,
    unit: "Pengikut",
    service_id: "1286",
    description: "Tambahkan pengikut ke saluran WhatsApp - Fayupedia V3",
    minQuantity: 15,
    maxQuantity: 1000,
    placeholder: "https://whatsapp.com/channel/xxxxx",
    needLink: true,
    ...
    unit: "Save",
    service_id: "979",
    description: "Tambahkan save ke video TikTok - Fayupedia",
    minQuantity: 100,
    maxQuantity: 1000,
    placeholder: "https://vt.tiktok.com/xxxxx",
    needLink: true,
    ...
    /* {
        ...
        unit: "Pengikut",
        service_id: "419",
        description: "Tambahkan Followers ke Akun TikTok",
        minQuantity: 10,
        maxQuantity: 10000,
    ...
    unit: "Pengikut",
    service_id: "1734",
    description: "Tambahkan Followers ke Akun TikTok - Fayupedia",
    minQuantity: 10,
    maxQuantity: 1000,
    placeholder: "@yuss_xy/link profil",
    needLink: true,
    ...
    
    {
        id: 11,
        kategori: 'telegram',
        name: "Telegram Reactions + Free Views",
        price: 1300,
        unit: "Reaksi",
        service_id: "122",
        description: "Telegram Reactions + Free Views | Crying Face | Max 100K | Day 100K",
        minQuantity: 10,
        maxQuantity: 300000,
        placeholder: "https://t.me/username/12345 (link ke pesan)",
        needLink: true,
        step: 10,
        addAtSymbol: false,
    ...
    kategori: 'instagram',
    provider: 'fayupedia',
    name: "Instagram Followers V2",
    price: 20000,
    unit: "Pengikut",
    service_id: "1151",
    description: "Tambahkan Followers ke Akun Instagram - Fayupedia V2",
    minQuantity: 10,
    maxQuantity: 1000,
    placeholder: "Username/link profil",
    needLink: true,
    ...
    unit: "Like",
    service_id: "1766",
    description: "Tambahkan Like dari akun Indonesia ke postingan Instagram - Fayupedia",
    minQuantity: 100,
    maxQuantity: 1000,
...
},
{
    ...
    kategori: 'instagram',
    provider: 'fayupedia',
    name: "Instagram Komentar Custom",
    price: 25000,
    unit: "Komentar",
    service_id: "1567",
    description: "Tambahkan komentar custom ke postingan Instagram - Fayupedia",
    minQuantity: 20,
    maxQuantity: 1000,
    placeholder: "https://www.instagram.com/p/xxxxx",
    needLink: true,
    ...
    
    {
        ...
        unit: "view",
        service_id: "35",
        description: "Tambahkan view ke postingan/reels Instagram - Proses Otomatis",
        minQuantity: 150,
        maxQuantity: 50000,
        placeholder: "https://www.instagram.com/p/xxxxx atau /reel/xxxxx",
        needLink: true,
        ...
        id: 9,
        kategori: 'telegram',
        name: "Pengikut Saluran Telegram",
        price: 27000,
        unit: "Pengikut",
        service_id: "342",
        description: "Tambahkan pengikut ke saluran Telegram - Proses Otomatis",
        minQuantity: 10,
        maxQuantity: 10000,
    ...
    },
    {
        id: 10,
        kategori: 'telegram',
        name: "Member Grup Telegram",
        price: 25000,
        unit: "Member",
        service_id: "342",
        description: "Tambahkan member ke grup Telegram - Proses Otomatis",
        minQuantity: 10,
        maxQuantity: 10000,
        placeholder: "https://t.me/+xxxxx atau https://t.me/joinchat/xxxxx",
        needLink: true,
        step: 10,
        addAtSymbol: false,
        regex: /^https:\/\/t\.me\/(\+[a-zA-Z0-9_]+|joinchat\/[a-zA-Z0-9_]+|[a-zA-Z0-9_]+)$/
    },
...
// ================================================
// 🔥 CEK DEPOSIT PENDING - TAMPILKAN BANNER
// ================================================
...
(function() {
    ...
    if (pending) {
        try {
            ...
            const maxAge = 900000; // 15 MENIT
            
            // Kalau expired, hapus
            if (elapsed >= maxAge) {
                localStorage.removeItem('pending_deposit');
                console.log('🗑️ Pending deposit expired and removed');
                return;
            }
            
            // Kalau masih pending, TAMPILKAN BANNER
            if (elapsed < maxAge) {
                console.log('⏰ Deposit pending:', data.depositId);
                
                if (document.readyState === 'loading') {
                    document.addEventListener('DOMContentLoaded', function() {
                        showDepositPendingBanner(data);
                    });
                } else {
                    showDepositPendingBanner(data);
                }
...
// ================================================
// 🔥 TAMPILKAN BANNER "KAMU SEDANG DEPOSIT"
// ================================================

function showDepositPendingBanner(data) {
    const existing = document.getElementById('depositPendingBanner');
    ...
    const yussUrl = 'yuss.html?' +
        'depositId=' + encodeURIComponent(data.depositId) +
        '&username=' + encodeURIComponent(data.username) +
        '&amount=' + encodeURIComponent(data.amount) +
        '&uniqueCode=' + encodeURIComponent(data.uniqueCode || '') +
        '&totalAmount=' + encodeURIComponent(data.totalAmount || data.amount) +
        '&qrImage=' + encodeURIComponent(data.qrImage || '') +
        '&ramaDepositId=' + encodeURIComponent(data.ramaDepositId || data.depositId);

    const banner = document.createElement('div');
    banner.id = 'depositPendingBanner';
    ...
    banner.innerHTML = `
        <div style="display: flex; align-items: center; gap: 10px;">
            <div style="
                ...
                flex-shrink: 0;
            ">
                <i class="ri-loader-4-line" style="font-size: 16px; color: #f59e0b; animation: spin 0.8s linear infinite;"></i>
            </div>
            <div style="flex: 1; min-width: 0;">
                <div style="font-size: 12px; font-weight: 600; color: #f1f5f9;">
                    <i class="ri-time-line" style="font-size: 11px; margin-right: 3px;"></i> DEPOSIT
                </div>
                <div style="font-size: 10px; color: #94a3b8; margin-top: 1px;">
                    <i class="ri-money-dollar-circle-line" style="font-size: 10px; margin-right: 3px;"></i>
                    Rp ${data.amount.toLocaleString('id-ID')}
                    <span id="depositPendingTimer" style="color: #f59e0b; font-weight: 600; font-size: 11px; margin-left: 4px;">
                        ${String(minutes).padStart(2, '0')}:${String(seconds).padStart(2, '0')}
                    </span>
                </div>
            </div>
            <a href="${yussUrl}" style="
                padding: 6px 14px;
            ...
            ">
                <i class="ri-qr-code-line" style="font-size: 13px;"></i> Bayar
            </a>
            <button onclick="showCancelDepositModal()" style="
                padding: 6px 8px;
    ...
    if (window._depositTimerInterval) {
        clearInterval(window._depositTimerInterval);
    }

    window._depositTimerInterval = setInterval(() => {
        const elapsed2 = Math.floor((Date.now() - data.timestamp) / 1000);
        const remaining2 = Math.max(0, maxAge - elapsed2);
        const m = Math.floor(remaining2 / 60);
        const s = remaining2 % 60;
        const timerEl = document.getElementById('depositPendingTimer');
        ...
        if (remaining2 <= 0) {
            clearInterval(window._depositTimerInterval);
            window._depositTimerInterval = null;
            localStorage.removeItem('pending_deposit');
            removeDepositPendingBanner();
            showToast('⏰ Waktu deposit habis (15 menit)', true);
        }
    }, 1000);
}

function removeDepositPendingBanner() {
    const banner = document.getElementById('depositPendingBanner');
    if (banner) {
        banner.style.animation = 'fadeOutDown 0.3s ease forwards';
        setTimeout(function() {
...
// ================================================
// 🔥 MODAL BATALKAN DEPOSIT - TANPA ID + ANIMASI HALUS
// ================================================

function showCancelDepositModal() {
    const pending = localStorage.getItem('pending_deposit');
    if (!pending) {
        showDepositToast('Tidak ada deposit yang aktif', true);
        return;
    }

    const existing = document.getElementById('cancelDepositModal');
    if (existing) existing.remove();

    const modal = document.createElement('div');
    modal.id = 'cancelDepositModal';
    modal.style.cssText = `
        position: fixed;
        top: 0;
        left: 0;
    ...
    modal.innerHTML = `
        ...
        ">
            ...
            ">
                <i class="ri-close-circle-line" style="font-size: 28px; color: #ef4444; transition: all 0.3s ease;"></i>
            </div>
            ...
            ">
                Saldo tidak akan masuk jika kamu membatalkan.
            </p>

            <div style="display: flex; gap: 10px;">
                <button onclick="closeCancelDepositModal()" style="
                    flex: 1;
                    padding: 11px 14px;
                    border-radius: 30px;
                    font-weight: 600;
                ...
                <button onclick="confirmCancelDeposit()" style="
                    flex: 1;
                    padding: 11px 14px;
                    border-radius: 30px;
                    font-weight: 600;
...
function confirmCancelDeposit() {
    // 🔥 BATALKAN SEMUA
    localStorage.removeItem('pending_deposit');
    localStorage.removeItem('deposit_back_home');
    localStorage.removeItem('deposit_status_cache');
    localStorage.removeItem('deposit_checked');
    
    removeDepositPendingBanner();
    closeCancelDepositModal();
    showDepositToast('❌ Deposit dibatalkan', true);
    getSaldo();
}
...
async function checkPendingDeposit() {
    ...
    try {
        ...
        if (elapsed > maxAge) {
            localStorage.removeItem('pending_deposit');
            removeDepositPendingBanner();
            showToast('⏰ Deposit kadaluarsa', true);
            return;
        }
        ...
        if (result.success && result.data.status === 'success') {
            ...
            removeDepositPendingBanner();
            await getSaldo();
            showToast('✅ Deposit Rp ' + data.amount.toLocaleString('id-ID') + ' berhasil!');
...
function isDepositActive() {
    ...
    try {
        ...
        // Kalau belum expired, deposit masih aktif
        if (elapsed < maxAge) {
            return true;
        } else {
            // Kalau expired, hapus
...
function showDepositToast(message, isError = false) {
    // Hapus toast deposit lama
    const existing = document.querySelector('.deposit-toast-msg');
    if (existing) existing.remove();

    const toast = document.createElement('div');
    toast.className = 'deposit-toast-msg';
    
    // 🔥 WARNA LEBIH ELEGAN & SOFT
    const bgColor = isError 
        ? 'rgba(20, 20, 30, 0.88)' 
        : 'rgba(16, 185, 129, 0.88)';
    
    const borderColor = isError ? 'rgba(239, 68, 68, 0.15)' : 'rgba(16, 185, 129, 0.15)';
    const icon = isError ? 'ri-alert-line' : 'ri-check-line';
    const iconColor = isError ? '#f59e0b' : '#ffffff';
    const textColor = isError ? '#f1f5f9' : '#ffffff';
    ...
    const badgeBg = isError ? 'rgba(239,68,68,0.12)' : 'rgba(255,255,255,0.12)';
    ...
    toast.innerHTML = `
        ...
        ">
            <div style="
                ...
                flex-shrink: 0;
            ">
                <i class="${icon}" style="font-size: 12px; color: ${iconColor};"></i>
            </div>
            <span style="
                flex: 1; 
                text-align: center; 
        ...
        <div style="
            ...
            width: 40%;
            height: 2px;
            background: ${isError ? 'rgba(245, 158, 11, 0.3)' : 'rgba(255,255,255,0.25)'};
            border-radius: 2px;
...
function navigateWithAnimation(url) {
    ...
    // Tunggu animasi selesai (300ms), lalu redirect
    setTimeout(() => {
        window.location.href = url;
    }, 300);
}

// Fungsi untuk animasi masuk saat halaman dimuat
...
if (product.isGameTopup || product.id === 33) {
    console.log("Ini produk Topup Game, redirect ke topup.html dengan animasi");
    navigateWithAnimation(product.topupLink || "game/topup.html");
    return;
}
...
document.addEventListener('DOMContentLoaded', () => {
   ...
   setTimeout(() => {
    ...
    setInterval(checkPendingDeposit, 10000);
...
// ================================================
// TOOL STALK FREE FIRE (GANTI TRANSLATE)
// ================================================

// Ambil elemen dengan ID baru
const stalkFfBtn = document.getElementById('stalkFfBtn');
const ffUidInput = document.getElementById('ffUidInput');
const ffStalkResult = document.getElementById('ffStalkResult');

// Pastikan elemen ada
if (stalkFfBtn && ffUidInput && ffStalkResult) {
    
    // Hapus event listener lama
    const newBtn = stalkFfBtn.cloneNode(true);
    stalkFfBtn.parentNode.replaceChild(newBtn, stalkFfBtn);

    newBtn.addEventListener('click', async function() {
        let uid = ffUidInput.value.trim();

        // Validasi
        if (!uid) {
            showToast('❌ Masukkan UID Free Fire!', true);
            return;
        }

        // Validasi UID (hanya angka)
        if (!/^\d+$/.test(uid)) {
            showToast('❌ UID harus berupa angka!', true);
            return;
        }

        // Tampilkan loading
        ffStalkResult.style.display = 'block';
        ffStalkResult.innerHTML = `
            <div class="ff-stalk-loading">
                <div class="ff-loading-spinner"></div>
                <p>🔍 Mencari data player...</p>
                <span style="font-size: 11px; color: var(--text-secondary);">UID: ${uid}</span>
            </div>
        `;
        ...
        try {
            ...
            // 🔥 API STALK FREE FIRE
            const apiUrl = `https://api.ikyyxd.my.id/stalk/epepid?uid=${encodedUid}`;
            ...
            // Tentukan rank berdasarkan BR Rank Point
            let rankEmoji = '🆕';
            let rankColor = '#6b7280';
            let rankName = 'Pemula';
            
            if (player.br_rank_point >= 5000) {
                rankEmoji = '👑';
                rankColor = '#fbbf24';
                rankName = 'Heroic';
            } else if (player.br_rank_point >= 3500) {
                rankEmoji = '⭐';
                rankColor = '#f59e0b';
                rankName = 'Grandmaster';
            } else if (player.br_rank_point >= 2500) {
                rankEmoji = '🔥';
                rankColor = '#ef4444';
                rankName = 'Master';
            } else if (player.br_rank_point >= 1800) {
                rankEmoji = '⚔️';
                rankColor = '#3b82f6';
                rankName = 'Diamond';
            } else if (player.br_rank_point >= 1200) {
                rankEmoji = '🥈';
                rankColor = '#8b5cf6';
                rankName = 'Platinum';
            } else if (player.br_rank_point >= 800) {
                rankEmoji = '🥉';
                rankColor = '#10b981';
                rankName = 'Gold';
            } else if (player.br_rank_point >= 400) {
                rankEmoji = '⚡';
                rankColor = '#f97316';
                rankName = 'Silver';
            } else if (player.br_rank_point > 0) {
                rankEmoji = '🪖';
                rankColor = '#6b7280';
                rankName = 'Bronze';
            }
            ...
            // Tampilkan hasil
            ffStalkResult.innerHTML = `
                <div class="ff-stalk-result">
                    <!-- Banner -->
                    <div class="ff-banner" style="background-image: url('${player.banner_image || 'https://placehold.co/400x120/1a1a2e/white?text=Free+Fire'}');">
                        <div class="ff-banner-overlay">
                            <div class="ff-banner-content">
                                <div class="ff-level-badge">Lv. ${player.level || 1}</div>
                                <div class="ff-player-name">${escapeHtml(player.name || 'Unknown Player')}</div>
                                <div class="ff-player-uid">UID: ${player.uid || uid}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ff-stats-grid">
                        <div class="ff-stat-card">
                            <div class="ff-stat-icon"><i class="ri-fire-line" style="color: #f59e0b;"></i></div>
                            <div class="ff-stat-info">
                                <div class="ff-stat-number">${formatNumber(player.br_rank_point)}</div>
                                <div class="ff-stat-label">BR Rank Point</div>
                            </div>
                        </div>
                        <div class="ff-stat-card">
                            <div class="ff-stat-icon"><i class="ri-medal-line" style="color: #fbbf24;"></i></div>
                            <div class="ff-stat-info">
                                <div class="ff-stat-number" style="color: ${rankColor};">${rankEmoji} ${rankName}</div>
                                <div class="ff-stat-label">Rank</div>
                            </div>
                        </div>
                        <div class="ff-stat-card">
                            <div class="ff-stat-icon"><i class="ri-user-line" style="color: #3b82f6;"></i></div>
                            <div class="ff-stat-info">
                                <div class="ff-stat-number">${player.cs_rank_point ? formatNumber(player.cs_rank_point) : '-'}</div>
                                <div class="ff-stat-label">CS Rank Point</div>
                            </div>
                        </div>
                    </div>

                    <!-- Info Tambahan -->
                    <div class="ff-extra-info">
                        <div class="ff-extra-item">
                            <i class="ri-global-line" style="color: #3b82f6;"></i>
                            <span>Region: <strong>${player.region || '-'}</strong></span>
                        </div>
                        <div class="ff-extra-item">
                            <i class="ri-calendar-line" style="color: #10b981;"></i>
                            <span>Bergabung: <strong>${formatDate(player.created_at)}</strong></span>
                        </div>
                        <div class="ff-extra-item">
                            <i class="ri-time-line" style="color: #f59e0b;"></i>
                            <span>Terakhir Login: <strong>${formatDate(player.last_login)}</strong></span>
                        </div>
                        ${player.guild_name ? `
                        <div class="ff-extra-item">
                            <i class="ri-group-line" style="color: #8b5cf6;"></i>
                            <span>Guild: <strong>${escapeHtml(player.guild_name)}</strong></span>
                        </div>
                        ` : ''}
                    </div>

                    <!-- Footer - TANPA CREATOR -->
                    <div class="ff-stalk-footer">
                        <i class="ri-flashlight-line" style="color: var(--accent);"></i>
                        <span>YussXy Store</span>
                    </div>

                    <!-- Tombol Salin UID -->
                    <button class="ff-copy-uid" onclick="copyToClipboard('${player.uid || uid}', 'UID Free Fire')">
                        <i class="ri-file-copy-line"></i> Salin UID
                    </button>
                </div>
            `;

            showToast(`✅ Data player ${player.name || uid} berhasil diambil!`);

        } catch (error) {
            console.error('FF Stalk Error:', error);
            ffStalkResult.innerHTML = `
                <div class="ff-stalk-error">
                    <i class="ri-error-warning-line" style="font-size: 32px; display: block; margin-bottom: 12px; color: #ef4444;"></i>
                    <strong>❌ Gagal Mengambil Data</strong>
                    <p style="font-size: 13px; color: var(--text-secondary); margin-top: 8px;">
                        ${error.message || 'Pastikan UID benar dan coba lagi.'}
                    </p>
                    <p style="font-size: 11px; color: var(--text-secondary); margin-top: 4px;">
                        💡 Pastikan UID Free Fire aktif dan benar.
                    </p>
                    <button onclick="location.reload()" style="margin-top: 14px; padding: 10px 24px; background: var(--accent); border: none; border-radius: 30px; color: white; font-weight: 600; cursor: pointer;">
                        <i class="ri-refresh-line"></i> Coba Lagi
                    </button>
                </div>
            `;
            showToast('❌ Gagal mengambil data player', true);
        }
    });
}
...
// ================================================
// TOOL STALK TIKTOK (GANTI TIKTOK HASHTAG)
// ================================================

// Ambil elemen dengan ID baru
const stalkTiktokBtn = document.getElementById('stalkTiktokBtn');
const stalkUsername = document.getElementById('stalkUsername');
const stalkResult = document.getElementById('stalkResult');

// Pastikan elemen ada
if (stalkTiktokBtn && stalkUsername && stalkResult) {
    
    // Hapus event listener lama (biar ga dobel)
    const newBtn = stalkTiktokBtn.cloneNode(true);
    stalkTiktokBtn.parentNode.replaceChild(newBtn, stalkTiktokBtn);

    newBtn.addEventListener('click', async function() {
        let username = stalkUsername.value.trim();

        // Validasi
        if (!username) {
            showToast('❌ Masukkan username TikTok!', true);
            return;
        }
        ...
        stalkResult.innerHTML = '<div class="result-loading"><i class="ri-loader-4-line" style="animation: spin 1s linear infinite;"></i> Mengambil data profil...</div>';
        ...
        try {
            ...
            // 🔥 API STALK TIKTOK
            const apiUrl = `https://api.ikyyxd.my.id/stalk/tiktok?username=${encodedUsername}`;
            ...
            // Cek status response
            if (!data.status) {
                throw new Error(data.result?.msg || 'Gagal mengambil data');
            }
            ...
            // Format waktu bergabung
            const joinDate = result.create_time 
                ? new Date(result.create_time * 1000).toLocaleDateString('id-ID', { 
                    day: 'numeric', 
                    month: 'long', 
                    year: 'numeric' 
                  })
            ...
            // Tampilkan hasil
            stalkResult.innerHTML = `
                <div class="stalk-result">
                    <!-- Header Profil -->
                    <div class="stalk-profile-header">
                        <div class="stalk-avatar">
                            <img src="${result.avatar?.medium || result.avatar?.thumb || 'https://placehold.co/80x80/333/white?text=T'}" 
                                 alt="Avatar" 
                                 onerror="this.src='https://placehold.co/80x80/333/white?text=T'">
                        </div>
                        <div class="stalk-profile-info">
                            <div class="stalk-nickname">${escapeHtml(result.nickname || result.username)}</div>
                            <div class="stalk-username">@${escapeHtml(result.username)}</div>
                            ${result.verified ? '<span class="stalk-verified"><i class="ri-verified-badge-fill"></i> Verified</span>' : ''}
                            ${result.private ? '<span class="stalk-private"><i class="ri-lock-line"></i> Private</span>' : ''}
                        </div>
                    </div>
                    ...
                    ${result.bio ? `
                    <div class="stalk-bio">
                        <i class="ri-quote-line"></i>
                        <span>${escapeHtml(result.bio)}</span>
                    </div>
                    ` : ''}

                    <!-- Stats Grid -->
                    <div class="stalk-stats-grid">
                        <div class="stalk-stat-item">
                            <div class="stalk-stat-number">${formatNumber(result.stats?.followers)}</div>
                            <div class="stalk-stat-label"><i class="ri-user-follow-line"></i> Followers</div>
                        </div>
                        <div class="stalk-stat-item">
                            <div class="stalk-stat-number">${formatNumber(result.stats?.following)}</div>
                            <div class="stalk-stat-label"><i class="ri-user-add-line"></i> Following</div>
                        </div>
                        <div class="stalk-stat-item">
                            <div class="stalk-stat-number">${formatNumber(result.stats?.likes)}</div>
                            <div class="stalk-stat-label"><i class="ri-heart-line"></i> Likes</div>
                        </div>
                        <div class="stalk-stat-item">
                            <div class="stalk-stat-number">${formatNumber(result.stats?.videos)}</div>
                            <div class="stalk-stat-label"><i class="ri-video-line"></i> Videos</div>
                        </div>
                    </div>

                    <!-- Info Tambahan -->
                    <div class="stalk-extra-info">
                        <div class="stalk-extra-item">
                            <i class="ri-calendar-line"></i>
                            <span>Bergabung: <strong>${joinDate}</strong></span>
                        </div>
                        <div class="stalk-extra-item">
                            <i class="ri-fingerprint-line"></i>
                            <span>User ID: <strong style="font-family: monospace; font-size: 11px;">${result.id || '-'}</strong></span>
                        </div>
                    </div>

                    <!-- Tombol Buka Profil -->
                    <button class="stalk-open-profile" onclick="window.open('https://www.tiktok.com/@${escapeHtml(result.username)}', '_blank')">
                        <i class="ri-tiktok-line"></i> Buka Profil TikTok
                    </button>
                </div>
            `;

            showToast(`✅ Data @${result.username} berhasil diambil!`);
            ...
            stalkResult.innerHTML = `
                <div class="result-error">
                    ...
                    ❌ ${error.message || 'Gagal mengambil data profil'}
    ...
    console.warn('⚠️ Elemen Stalk TikTok tidak ditemukan! Cek ID di HTML.');
}
...
// ================================================
// TOOL IQC - QUOTE CHAT (GANTI EMOJI MIX)
// ================================================

// Ambil elemen dengan ID baru
const generateIqcBtn = document.getElementById('generateIqcBtn');
const iqcText = document.getElementById('iqcText');
const iqcResult = document.getElementById('iqcResult');

// Pastikan elemen ada
if (generateIqcBtn && iqcText && iqcResult) {
    
    // Hapus event listener lama (biar ga dobel)
    const newBtn = generateIqcBtn.cloneNode(true);
    generateIqcBtn.parentNode.replaceChild(newBtn, generateIqcBtn);

    newBtn.addEventListener('click', async function() {
        let text = iqcText.value.trim();

        // Validasi
        if (!text) {
            showToast('❌ Masukkan teks pesan!', true);
            return;
        }

        // Tampilkan loading
        iqcResult.style.display = 'block';
        iqcResult.innerHTML = '<div class="result-loading"><i class="ri-loader-4-line" style="animation: spin 1s linear infinite;"></i> Generating...</div>';
        ...
        try {
            ...
            // 🔥 API IQC
            const apiUrl = `https://api.ikyyxd.my.id/canvas/iqc?text=${encodedText}&chatTime=${currentTime}&statusBarTime=y`;
            ...
            // Tampilkan hasil
            iqcResult.innerHTML = `
                <div class="iqc-result">
                    <div class="iqc-info">
                        <i class="ri-chat-quote-line" style="font-size: 40px; color: #8b5cf6;"></i>
                        <div class="iqc-details">
                            <p style="font-weight: 700; font-size: 16px;">💬 Quote Chat</p>
                            <p style="color: #c084fc; font-style: italic; font-size: 14px;">"${escapeHtml(text)}"</p>
                            <p style="font-size: 11px; color: var(--text-secondary); margin-top: 4px;">
                                <i class="ri-time-line"></i> ${currentTime.replace('.', ':')}
                            </p>
                        </div>
                    </div>
                    <div class="image-preview">
                        <img src="${imageUrl}" class="iqc-image" alt="IQC Quote" onclick="showFullImage(this.src)">
                        <button class="view-image-btn" onclick="showFullImage('${imageUrl}')">
                            <i class="ri-eye-line"></i> Lihat Gambar
                        </button>
                    </div>
                    <button class="direct-download-btn" id="iqcDownloadBtn">
            ...
            // Event download
            document.getElementById('iqcDownloadBtn').addEventListener('click', function() {
                const link = document.createElement('a');
                link.href = imageUrl;
                link.download = `iqc_${text.substring(0, 20).replace(/[^a-z0-9]/gi, '_')}.png`;
            ...
            showToast('✅ Quote Chat berhasil dibuat!');

        } catch (error) {
            console.error('IQC Error:', error);
            iqcResult.innerHTML = `<div class="result-error">❌ Error: ${error.message}</div>`;
            showToast('❌ Gagal koneksi ke server', true);
        }
    });

} else {
    console.warn('⚠️ Elemen IQC tidak ditemukan! Cek ID di HTML.');
}



// ================================================
// TOOL WINDOWS QUOTE (GANTI HITUNG WR MLBB)
// ================================================

// Ambil elemen dengan ID baru
const generateWindowsQuoteBtn = document.getElementById('generateWindowsQuoteBtn');
const windowsQuoteText = document.getElementById('windowsQuoteText');
const windowsQuoteResult = document.getElementById('windowsQuoteResult');

// Pastikan elemen ada
if (generateWindowsQuoteBtn && windowsQuoteText && windowsQuoteResult) {
    
    // Hapus event listener lama (biar ga dobel)
    const newBtn = generateWindowsQuoteBtn.cloneNode(true);
    generateWindowsQuoteBtn.parentNode.replaceChild(newBtn, generateWindowsQuoteBtn);

    newBtn.addEventListener('click', async function() {
        let text = windowsQuoteText.value.trim();

        // Validasi
        if (!text) {
            showToast('❌ Masukkan teks quote!', true);
            return;
        }

        // Tampilkan loading
        windowsQuoteResult.style.display = 'block';
        windowsQuoteResult.innerHTML = '<div class="result-loading"><i class="ri-loader-4-line" style="animation: spin 1s linear infinite;"></i> Generating...</div>';
        ...
        try {
            ...
            // 🔥 API WINDOWS QUOTE
            const apiUrl = `https://api-nanzz.my.id/docs/api/maker/windows-quotes.php?text=${encodedText}`;
            ...
            // Tampilkan hasil
            windowsQuoteResult.innerHTML = `
                <div class="windows-quote-result">
                    <div class="windows-quote-info">
                        <i class="ri-windows-line" style="font-size: 40px; color: #00a4ef;"></i>
                        <div class="windows-quote-details">
                            <p style="font-weight: 700; font-size: 16px;">🪟 Windows Quote</p>
                            <p style="color: #60a5fa; font-style: italic; font-size: 14px;">"${escapeHtml(text)}"</p>
                        </div>
                    </div>
                    <div class="image-preview">
                        <img src="${imageUrl}" class="windows-quote-image" alt="Windows Quote" onclick="showFullImage(this.src)">
                        <button class="view-image-btn" onclick="showFullImage('${imageUrl}')">
                            <i class="ri-eye-line"></i> Lihat Gambar
                        </button>
                    </div>
                    <button class="direct-download-btn" id="windowsQuoteDownloadBtn">
                        <i class="ri-download-line"></i> Download Gambar
                    </button>
                </div>
            `;
            ...
            // Event download
            document.getElementById('windowsQuoteDownloadBtn').addEventListener('click', function() {
                const link = document.createElement('a');
                link.href = imageUrl;
                link.download = `windows_quote_${text.substring(0, 20).replace(/[^a-z0-9]/gi, '_')}.png`;
                document.body.appendChild(link);
                link.click();
                document.body.removeChild(link);
                showToast('⏬ Download dimulai...');
            ...
            showToast('✅ Windows Quote berhasil dibuat!');

        } catch (error) {
            console.error('Windows Quote Error:', error);
            windowsQuoteResult.innerHTML = `<div class="result-error">❌ Error: ${error.message}</div>`;
            showToast('❌ Gagal koneksi ke server', true);
        }
    });

} else {
    console.warn('⚠️ Elemen Windows Quote tidak ditemukan! Cek ID di HTML.');
}
...
if (generateDanaBtn) {
    generateDanaBtn.addEventListener('click', async function() {
        ...
        try {
            // API BARU: kyzznekoo.zone.id
            const apiUrl = `https://api.ikyyxd.my.id/canvas/fakedana?amount=${encodeURIComponent(nominal)}`;
...
// ================================================
// TOOLS FAKE NGL - GENERATE PESAN ANONIM
// ================================================

const generateNglBtn = document.getElementById('generateJagoBtn');
const nglTextInput = document.getElementById('jagoNama'); // reuse input
const nglResult = document.getElementById('jagoResult');

if (generateNglBtn) {
    // Update label input
    const label = document.querySelector('#jagoNama')?.closest('.input-group')?.querySelector('label');
    if (label) {
        label.innerHTML = '<i class="ri-chat-1-line"></i> Teks Pesan';
    }
    const placeholder = document.getElementById('jagoNama');
    if (placeholder) {
        placeholder.placeholder = 'Masukkan pesan anonim...';
    }
    
    // Sembunyikan input saldo
    const saldoGroup = document.getElementById('jagoSaldo')?.closest('.input-group');
    if (saldoGroup) {
        saldoGroup.style.display = 'none';
    }

    generateNglBtn.addEventListener('click', async function() {
        let text = nglTextInput.value.trim();
        if (!text) {
            showToast('❌ Masukkan teks pesan!', true);
            return;
        }

        nglResult.style.display = 'block';
        nglResult.innerHTML = '<div class="result-loading"><i class="ri-loader-4-line" style="animation: spin 1s linear infinite;"></i> Generating...</div>';

        try {
            const encodedText = encodeURIComponent(text);
            // 🔥 API FAKE NGL
            const apiUrl = `https://api-nanzz.my.id/docs/api/maker/fake-ngl.php?text=${encodedText}`;
            const response = await fetch(apiUrl);
            ...
            nglResult.innerHTML = `
                <div class="jago-result">
                    <div class="jago-info">
                        <i class="ri-chat-smile-3-line" style="font-size: 40px; color: #8b5cf6;"></i>
                        <div class="jago-details">
                            <p><strong>Pesan Anonim</strong></p>
                            <p style="color: #c084fc; font-style: italic;">"${escapeHtml(text)}"</p>
                        </div>
                    </div>
                    <div class="image-preview">
                        <img src="${imageUrl}" class="jago-image" alt="Fake NGL" onclick="showFullImage(this.src)">
                        <button class="view-image-btn" onclick="showFullImage('${imageUrl}')">
                            <i class="ri-eye-line"></i> Lihat Gambar
                        </button>
                    </div>
                    <button class="direct-download-btn" id="nglDownloadBtn">
                        <i class="ri-download-line"></i> Download Gambar
                    </button>
                </div>
            `;

            document.getElementById('nglDownloadBtn').addEventListener('click', function() {
                const link = document.createElement('a');
                link.href = imageUrl;
                link.download = `fake_ngl_${text.substring(0, 20).replace(/[^a-z0-9]/gi, '_')}.png`;
                document.body.appendChild(link);
                link.click();
                document.body.removeChild(link);
                showToast('⏬ Download dimulai...');
            ...
            showToast('✅ Pesan NGL berhasil dibuat!');
        } catch(e) {
            console.error('NGL Generator error:', e);
            nglResult.innerHTML = `<div class="result-error">❌ Error: ${e.message}</div>`;
            showToast('❌ Gagal koneksi', true);
        }
    });
}
...
if (generateMlBtn) {
    generateMlBtn.addEventListener('click', async function() {
        ...
        try {
            ...
            // API BARU: kyzznekoo.zone.id
            const apiUrl = `https://api-nanzz.my.id/docs/api/maker/fake-lobby-ml.php?username=${encodedNickname}&avatar=${encodedAvatar}&rank=imo&border=7`;
            const response = await fetch(apiUrl);
...
// ================================================
// FUNGSI TIKTOK DOWNLOADER - API v2 (FIXED)
// ================================================
...
if (downloadTiktokBtn) {
    downloadTiktokBtn.addEventListener('click', async function() {
        ...
        try {
            const encodedUrl = encodeURIComponent(url);
            // 🔥 API BARU: tiktokv2.php
            const apiUrl = `https://api-nanzz.my.id/docs/api/downloader/tiktokv2.php?url=${encodedUrl}`;
            const response = await fetch(apiUrl);
            const data = await response.json();

            // 🔥 RESPONSE BARU: { creator, status, result: { video_tanpa_watermark, audio_mp3, caption, author } }
            if (data.status === true && data.result && data.result.video_tanpa_watermark) {
                const result = data.result;
                ...
                if (!videoUrl || videoUrl === 'null') {
                    tiktokResult.innerHTML = `<div class="result-error">❌ Link video tidak valid. Coba lagi.</div>`;
                    showToast('❌ Link video tidak valid', true);
                    return;
                }

                // Bersihkan caption untuk nama file
                ...
                let html = `
                    <div class="result-thumb">
                        <div class="result-info-small">
                            <p><strong>${escapeHtml(caption.substring(0, 60))}${caption.length > 60 ? '...' : ''}</strong></p>
                            <p><i class="ri-user-line"></i> ${escapeHtml(author)}</p>
                        </div>
                    </div>
                    <div class="result-buttons">
                ...
                // Tambahan tombol audio jika tersedia
                ...
                tiktokResult.innerHTML = `<div class="result-error">❌ Gagal memproses video. Coba URL lain atau coba lagi nanti.</div>`;
...
function showReaction1000Modal(product) {
    ...
    btn.addEventListener('click', async () => {
        ...
        if (!isValidChannelLink(link)) {
            return showToast("Masukan link pesan jangan link sl", true);
        }
        ...
        try {
            ...
            // =========================
            // KIRIM RCWA - TARGET OTOMATIS DARI BACKEND
            // =========================
...
function showDepositBottomSheet() {
    ...
    if (isDepositActive()) {
        showDepositToast('Kamu sedang deposit, selesaikan dulu atau batalkan.', true);
        return;
    }
...
// ================================================
// 🔥 CREATE DEPOSIT OTOMATIS - DENGAN LIMIT 100.000
// ================================================

const MAX_DEPOSIT = 100000; // Rp 100.000
...
async function createDepositOtomatis(amount) {
    ...
    const savedUser = localStorage.getItem('app_user');
    if (!savedUser) {
        showDepositToast('Silakan login terlebih dahulu', true);
        return;
    }
    ...
    try {
        ...
        showDepositToast('Gagal membaca data user', true);
        return;
    }

    const username = userData.username;
    if (!username) {
        showDepositToast('Username tidak ditemukan', true);
        return;
    }

    // VALIDASI MINIMAL
    if (!amount || amount < 500) {
        showDepositToast('Minimal deposit Rp 500', true);
        return;
    }

    // 🔥 CEK MAKSIMAL DEPOSIT
    if (amount > MAX_DEPOSIT) {
        showDepositToast(`⚠️ Maksimal deposit Rp ${MAX_DEPOSIT.toLocaleString('id-ID')}`, true);
        return;
    }

    showDepositToast('Membuat permintaan deposit...');
    ...
    try {
        ...
        if (!data.success) {
            showDepositToast(data.message || 'Gagal membuat deposit', true);
            return;
        }
        ...
        console.error('Error:', error);
        showDepositToast('Gagal koneksi ke server', true);
    }
}
    ...
    modal.innerHTML = `
        <div class="modal-content" style="max-width: 360px;">
            ...
            <div class="modal-body" id="apkOrderBody" style="text-align:left;">
                ...
                <div class="deposit-info" style="margin-bottom:16px;background:rgba(16,185,129,0.1);">
                    <i class="ri-information-line"></i>
                    <span>Link APK akan muncul setelah pembelian berhasil</span>
                </div>
    ...
    processBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            if (!searchData.success || !searchData.data) {
                ...
                processBtn.innerHTML = '<i class="ri-flashlight-line"></i> Beli Sekarang';
                return;
            }
            ...
            // =========================
            // TAMPILKAN HASIL SUKSES DENGAN LINK APK
            // =========================
            document.getElementById('apkOrderBody').innerHTML = `
                <div style="background: linear-gradient(145deg, #0f172a, #0a0f1a); padding: 24px 20px; border-radius: 24px; color: #fff; font-size: 13px; line-height: 1.6; text-align: center; border: 1px solid rgba(16, 185, 129, 0.2); box-shadow: 0 8px 20px rgba(0,0,0,0.3);">
                    ...
                    <!-- ===== LINK APK - BISA DI SALIN ===== -->
                    <div style="background: rgba(59, 130, 246, 0.1); border-radius: 16px; padding: 16px; margin-bottom: 16px; border: 1px solid rgba(59, 130, 246, 0.2);">
                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                            <i class="ri-link" style="color: #60a5fa; font-size: 18px;"></i>
                            <span style="font-weight: 600; color: #60a5fa;">Link APK:</span>
                            <button onclick="navigator.clipboard.writeText('${product.downloadLink}').then(() => showToast('✅ Link APK disalin!'))" style="margin-left: auto; background: rgba(59,130,246,0.2); border: none; border-radius: 20px; padding: 4px 12px; color: #60a5fa; font-size: 11px; cursor: pointer;">
                                <i class="ri-file-copy-line"></i> Salin
                            </button>
                        </div>
                        <a href="${product.downloadLink}" target="_blank" style="color: #60a5fa; word-break: break-all; font-size: 12px; text-decoration: underline; display: block;">
                    ...
                    <div style="background: rgba(16, 185, 129, 0.15); border-radius: 12px; padding: 12px;">
                        <i class="ri-checkbox-circle-line" style="color: #10b981; font-size: 16px; margin-right: 6px;"></i>
                        <span style="color: #10b981;">✅ Link APK tersedia di atas, klik untuk download atau salin link!</span>
                    </div>
...
function showDesignOrderModal(product) {
    ...
    modal.innerHTML = `
        <div class="modal-content" style="max-width: 360px;">
            ...
            <div class="modal-body" id="designOrderBody" style="text-align:left;">
                ...
                <div class="deposit-info" style="margin-bottom:16px;background:rgba(16,185,129,0.1);">
                    <i class="ri-information-line"></i>
                    <span>Link Mentahan Design akan muncul setelah pembelian berhasil</span>
                </div>
    ...
    processBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            // =========================
            // SIMPAN TRANSAKSI KE DATABASE (DENGAN LINK)
            // =========================
            const saveTransRes = await fetch('https://backend-delta-steel-38.vercel.app/api/balance', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    trx_id: {
                        ...
                        type: 'design',
                        amount: productPrice,
                        download_link: product.downloadLink, // ✅ SIMPAN LINK DI RIWAYAT
                        status: 'success',
                        created_at: new Date().toISOString()
                    }
                })
            ...
            // =========================
            // TAMPILKAN HASIL SUKSES DENGAN LINK DESIGN
            // =========================
            document.getElementById('designOrderBody').innerHTML = `
                <div style="background: linear-gradient(145deg, #0f172a, #0a0f1a); padding: 24px 20px; border-radius: 24px; color: #fff; font-size: 13px; line-height: 1.6; text-align: center; border: 1px solid rgba(16, 185, 129, 0.2); box-shadow: 0 8px 20px rgba(0,0,0,0.3);">
                    ...
                    <!-- ===== LINK DESIGN - BISA DI SALIN ===== -->
                    <div style="background: rgba(59, 130, 246, 0.1); border-radius: 16px; padding: 16px; margin-bottom: 16px; border: 1px solid rgba(59, 130, 246, 0.2);">
                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                            <i class="ri-link" style="color: #60a5fa; font-size: 18px;"></i>
                            <span style="font-weight: 600; color: #60a5fa;">Link Mentahan Design:</span>
                            <button onclick="navigator.clipboard.writeText('${product.downloadLink}').then(() => showToast('✅ Link Design disalin!'))" style="margin-left: auto; background: rgba(59,130,246,0.2); border: none; border-radius: 20px; padding: 4px 12px; color: #60a5fa; font-size: 11px; cursor: pointer;">
                                <i class="ri-file-copy-line"></i> Salin
                            </button>
                        </div>
                        <a href="${product.downloadLink}" target="_blank" style="color: #60a5fa; word-break: break-all; font-size: 12px; text-decoration: underline; display: block;">
                    ...
                    <div style="background: rgba(16, 185, 129, 0.15); border-radius: 12px; padding: 12px;">
                        <i class="ri-checkbox-circle-line" style="color: #10b981; font-size: 16px; margin-right: 6px;"></i>
                        <span style="color: #10b981;">✅ Link Design tersedia di atas, klik untuk download atau salin link!</span>
                    </div>
...
async function loadUserStatistics() {
    ...
    if (cached) {
        try {
            ...
            if (Date.now() - data.timestamp < cacheDuration) {
                totalUsersElem.innerText = data.total_users || 0;
                if (data.users) {
                    renderStats(data.users);
                }
                console.log("📊 Pake cache (10 menit)");
                return;
            }
        } catch(e) {}
    }
    ...
    try {
        const totalRes = await fetch("https://backend-delta-steel-38.vercel.app/api/balance", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "x-api-key": "sb_secret_Ok9VVXILGV6zybDzN0zVpA_U5k___GF"
            },
            body: JSON.stringify({ action: "get_total_users" })
        });
        const totalData = await totalRes.json();
        
        const usersRes = await fetch("https://backend-delta-steel-38.vercel.app/api/balance", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "x-api-key": "sb_secret_Ok9VVXILGV6zybDzN0zVpA_U5k___GF"
        ...
        if (totalData.success) {
            totalUsersElem.innerText = totalData.total_users || 0;
        } else {
            totalUsersElem.innerText = usersData.users?.length || 0;
        }
        
        if (usersData.success && usersData.users) {
            renderStats(usersData.users);
        } else {
        ...
        localStorage.setItem(cacheKey, JSON.stringify({
            timestamp: Date.now(),
            total_users: totalData.total_users || 0,
...
function renderStats(allUsers) {
    ...
    for (const user of allUsers) {
        ...
        if (user.trx_id && Array.isArray(user.trx_id) && user.trx_id.length > 0) {
            for (const trx of user.trx_id) {
                // HANYA HITUNG PEMBELIAN (BUKAN DEPOSIT)
                if (trx.type === 'deposit') continue;
                ...
                if (trx.type === 'transfer') productName = "Transfer ke DANA";
                if (trx.type === 'auto_sosmed') productName = trx.product_name || "Suntik Sosmed Otomatis";
                if (trx.type === 'premium_app') productName = trx.product_name || "Aplikasi Premium";
                if (trx.product_id === 29) productName = "Website Store";
                
                if (!productSales[productName]) {
                    productSales[productName] = { count: 0, total: 0 };
                }
                productSales[productName].count++;
                productSales[productName].total += trx.amount || 0;
            }
        }
    ...
    // 🔥 URUTKAN BERDASARKAN TOTAL NOMINAL (TERBANYAK)
            ...
            topUserCard.onclick = () => {
                ...
                const content = `
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        ...
                        <div class="detail-item">
                            <span class="detail-label"><i class="ri-shopping-bag-line"></i> Total Transaksi</span>
                            <span class="detail-value">${topUser.transactionCount}x</span>
                        </div>
                        <div class="detail-item">
...
if (typeof document !== 'undefined') {
    document.addEventListener('DOMContentLoaded', function() {
        loadUserStatistics();
        setInterval(loadUserStatistics, 300000);
    });
}
...
// Update fungsi getSaldo yang sudah ada, tambahkan panggilan updateUserNameDispla
...
function userLogout() {
    console.log('🚪 userLogout dipanggil!');
    ...
    if (userData) {
        try {
            ...
            if (user.username) {
                fetch('https://backend-delta-steel-38.vercel.app/api/balance', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'x-api-key': 'sb_secret_Ok9VVXILGV6zybDzN0zVpA_U5k___GF'
                ...
                .then(res => res.json())
                .then(data => {
                    console.log('✅ Force logout success:', data);
                })
                .catch(e => console.log('❌ Force logout error:', e));
            }
        } catch(e) {
    ...
    localStorage.removeItem('last_logout_attempt');
...
// ================================================
// 🔥 MODAL UPDATE AKUN - TANPA LOGOUT
// ================================================

function checkAndShowUpdateModal() {
    if (localStorage.getItem('account_updated') === 'true') return;
    ...
    if (deviceId && userData.device_id) {
    ...
    overlay.style.cssText = `
        ...
        align-items: center;
        justify-content: center;
        animation: updateModalFadeIn 0.4s ease;
    `;
    ...
    overlay.innerHTML = `
        <div class="update-modal-content" style="
            ...
            animation: updateModalPop 0.5s cubic-bezier(0.2, 0.9, 0.4, 1.1);
        ">
            <div style="
                width: 64px;
                height: 64px;
            ...
            ">
                <i class="ri-refresh-line" style="font-size: 32px; color: white;"></i>
            </div>
            ...
            <p style="
                ...
                margin-bottom: 24px;
            ">
                Agar akun kamu lebih aman dan bisa digunakan di 1 HP saja.
            </p>
            
            <button id="updateAccountBtn" style="
                width: 100%;
                padding: 14px;
                background: linear-gradient(135deg, #f59e0b, #ef4444);
                border: none;
    ...
    style.textContent = `
        ...
        @keyframes updateModalPop {
            from { opacity: 0; transform: scale(0.85) translateY(20px); }
            to { opacity: 1; transform: scale(1) translateY(0); }
        }
        @keyframes updateModalFadeOut {
            from { opacity: 1; }
            to { opacity: 0; }
        }
    `;
    ...
    document.getElementById('updateAccountBtn').addEventListener('click', function() {
        ...
        // ================================================
        // 2️⃣ GENERATE DEVICE ID (JIKA BELUM ADA)
        // ================================================
        if (!deviceId) {
        ...
        // ================================================
        // 3️⃣ UPDATE DEVICE_ID KE BACKEND (TANPA FORCE LOGOUT)
        // ================================================
        if (userData && userData.username) {
            ...
            .catch(e => console.log('⚠️ Update error:', e));
        }

        // ================================================
        // 4️⃣ UPDATE DATA USER DI LOCALSTORAGE
        // ================================================
        ...
        overlay.style.animation = 'updateModalFadeOut 0.3s ease forwards';
        setTimeout(() => {
            overlay.remove();
        }, 300);
...
if (logoutBtnInfo) {
    // 🔥 HAPUS EVENT LISTENER LAMA (BIAR GA DOBEL)
    const newLogoutBtn = logoutBtnInfo.cloneNode(true);
    logoutBtnInfo.parentNode.replaceChild(newLogoutBtn, logoutBtnInfo);
...
function showAutoSosmedModal() {
        ...
        newServiceSelect.onchange = function() {
            ...
            if (targetHint) {
                if (service.id === 1) {
                    ...
                    targetHint.innerHTML = 'Masukkan link postingan ig';
                } else if (service.id === 8) {
                    targetHint.innerHTML = 'Masukkan link postingan facebook';
                } else if (service.id === 9) {
                    targetHint.innerHTML = 'Masukkan link saluran Telegram (contoh: https://t.me/username)';
                } else if (service.id === 10) {
                    targetHint.innerHTML = 'Masukkan link grup Telegram (contoh: https://t.me/+xxxxx atau https://t.me/joinchat/xxxxx)';
                } else if (service.id === 11) {
                    targetHint.innerHTML = 'Masukkan link ke pesan Telegram (contoh: https://t.me/username/12345)';
                }
            }
    ...
    if (orderBtn) {
        ...
        newOrderBtn.onclick = async () => {
            ...
            // ========== VALIDASI TELEGRAM ==========
            if (selectedAutoService.id === 9) {
                const tgRegex = /^https:\/\/t\.me\/[a-zA-Z0-9_]+$/;
                if (!tgRegex.test(target)) {
                    showToast('Masukkan link saluran Telegram yang valid! (https://t.me/username)', true);
                    return;
                }
            } else if (selectedAutoService.id === 10) {
                const tgGroupRegex = /^https:\/\/t\.me\/(\+[a-zA-Z0-9_]+|joinchat\/[a-zA-Z0-9_]+|[a-zA-Z0-9_]+)$/;
                if (!tgGroupRegex.test(target)) {
                    showToast('Masukkan link grup Telegram yang valid! (https://t.me/+xxxxx atau https://t.me/joinchat/xxxxx)', true);
                    return;
                }
            } else if (selectedAutoService.id === 11) {
                const tgMsgRegex = /^https:\/\/t\.me\/[a-zA-Z0-9_]+\/\d+$/;
                if (!tgMsgRegex.test(target)) {
                    showToast('Masukkan link ke pesan Telegram yang valid! (https://t.me/username/12345)', true);
                    return;
                }
            }
            ...
            // ========== VALIDASI INSTAGRAM ==========
                ...
                const igPostRegex = /https?:\/\/(www\.)?instagram\.com\/(p|reel)\/[a-zA-Z0-9_-]+/;
                if (!igPostRegex.test(target)) {
                    showToast('Masukkan link postingan Instagram yang valid!', true);
                    return;
                }
            } 
            // ========== VALIDASI FACEBOOK ==========
            else if (selectedAutoService.id === 8) {
            ...
            const minQty = selectedAutoService.minQuantity;
            const maxQty = selectedAutoService.maxQuantity || 10000;
            ...
            if (quantity > maxQty) {
                showToast(`Maksimal ${maxQty.toLocaleString('id-ID')} ${selectedAutoService.unit}!`, true);
                return;
            }
...
function showCustomCommentInput() {
    var container = document.getElementById('customCommentContainer');
    if (!container) return;
    
    var existing = document.getElementById('customCommentTextarea');
    if (existing) return;
    
    container.innerHTML = `
        <div style="margin-bottom: 16px;">
            <label style="display: block; font-size: 12px; font-weight: 600; color: var(--text-secondary); margin-bottom: 6px;">
                <i class="ri-chat-1-line"></i> Komentar (pisahkan dengan enter)
            </label>
            <textarea id="customCommentTextarea" rows="4" class="service-target-input" placeholder="komentar 1&#10;komentar 2&#10;komentar 3" style="resize: vertical; min-height: 80px; width: 100%; padding: 10px; background: var(--bg-secondary); border: 1px solid var(--border); border-radius: 12px; color: var(--text-primary); font-size: 13px;"></textarea>
            <p style="font-size: 10px; color: var(--text-secondary); margin-top: 4px;">
                <i class="ri-information-line"></i> Setiap baris adalah 1 komentar. Minimal ${selectedLayanan ? selectedLayanan.minQuantity : 20} komentar.
            </p>
        </div>
    `;
}
...
function getCustomComments() {
    var textarea = document.getElementById('customCommentTextarea');
...
async function processAutoSosmedOrder(service, target, quantity, totalPrice, comments) {
    var modal = document.getElementById('autoSosmedModal');
    var modalBody = document.getElementById('autoSosmedBody');
    if (!modalBody) {
    ...
    `;
    var savedUser = localStorage.getItem('app_user');
    if (!savedUser) {
        showResultError(modalBody, 'Silakan login terlebih dahulu!');
        return;
    }
    var targetIdentifier = null;
    try {
    ...
    try {
        var checkBalanceRes = await fetch("https://backend-delta-steel-38.vercel.app/api/balance", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "x-api-key": "sb_secret_Ok9VVXILGV6zybDzN0zVpA_U5k___GF"
        ...
        var balanceData = await checkBalanceRes.json();
        if (!balanceData.success) {
            showResultError(modalBody, 'Gagal cek saldo: ' + (balanceData.message || 'Unknown error'));
            return;
        }
        var currentBalance = balanceData.data.balance || 0;
        ...
        var provider = service.provider || 'alluneed';
        var orderBody = {
            action: "order",
            service: parseInt(service.service_id),
            target: target,
            quantity: quantity.toString()
        };
        if (provider === 'fayupedia') {
            orderBody.provider = 'fayupedia';
            if (comments) orderBody.comments = comments;
        }
        var orderRes = await fetch("https://backend-delta-steel-38.vercel.app/api/order", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
        ...
        var orderId = null;
        if (provider === 'fayupedia') {
            if (orderData.status === true && orderData.order) {
                orderId = orderData.order;
            } else {
                var errorMsg = orderData.msg || orderData.message || "Gagal memproses order";
                showResultError(modalBody, errorMsg);
                return;
            }
        } else {
            if (orderData.response && orderData.data && orderData.data.id) {
                orderId = orderData.data.id;
            } else {
                var errorMsg = orderData.message || "Gagal memproses order";
                showResultError(modalBody, errorMsg);
                return;
            }
        }
        var subRes = await fetch('https://backend-delta-steel-38.vercel.app/api/balance', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'x-api-key': 'sb_secret_Ok9VVXILGV6zybDzN0zVpA_U5k___GF'
        ...
        if (!subData.success) {
            console.error("Gagal potong saldo, tapi order sudah terbuat di server!");
            showResultError(modalBody, 'Pesanan dibuat! Tapi gagal potong saldo. Hubungi admin.');
            return;
        }
        var transactionId = 'TRX' + Date.now().toString().slice(-8) + Math.floor(Math.random() * 1000);
        ...
        showResultSuccess(modalBody, service, target, quantity, totalPrice, orderId, subData.data.balance);
...
function setupStatusRefresh() {
    ...
    const COOLDOWN_KEY = 'store_cooldown';
    ...
    newBtn.addEventListener('click', function(e) {
        ...
        fetchStoreStatusCompact().finally(() => {
            setTimeout(() => {
                ...
                showToast('✅ Status toko diperbarui!');
            }, 500);
        });
    });
}
...
function initStoreStatus() {
    ...
    setupStatusRefresh();
    setInterval(fetchStoreStatusCompact, 300000);
}
        ...
        try {
            ...
            if (rawPhone && rawPhone.length > 0) {
                ...
                if (cleanPhone.length >= 6) {
                    const first6 = cleanPhone.substring(0, 6);
                    const remaining = cleanPhone.substring(6);
                    const masked = remaining.replace(/./g, 'x');
                    phoneNumber = first6 + masked;
                } else {
...
├ Pembayaran : Saldo Yuss Xy
├ Tanggal Pembelian : ${tanggal} ${jam}
...
function confirmLogout() {
    ...
    if (userData) {
        try {
            ...
            if (user.username) {
                // 🔥 PAKSA PANGGIL force_logout SEBELUM HAPUS DATA
                fetch('https://backend-delta-steel-38.vercel.app/api/balance', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
...
const ACTIVITY_CACHE_KEY = 'activity_data_cache';
const ACTIVITY_CACHE_DURATION = 5 * 60 * 1000;
const ACTIVITY_COOLDOWN_KEY = 'activity_cooldown';

function getActivityCooldown() {
    try {
        const data = localStorage.getItem(ACTIVITY_COOLDOWN_KEY);
        return data ? parseInt(data) : 0;
    } catch(e) {
        return 0;
    }
...
function setActivityCooldown(time) {
    localStorage.setItem(ACTIVITY_COOLDOWN_KEY, String(time));
}
...
function saveActivityCache(transactions) {
    try {
        localStorage.setItem(ACTIVITY_CACHE_KEY, JSON.stringify({
            timestamp: Date.now(),
            value: transactions
        }));
    } catch (e) {}
...
async function loadActivity(forceRefresh = false) {
    ...
    container.innerHTML = `
        <div style="display:flex;justify-content:center;align-items:center;height:100%;min-height:150px;flex-direction:column;gap:12px;">
            ...
            <p style="font-size:12px;color:var(--text-secondary);">${forceRefresh ? 'Mengambil data terbaru...' : 'Memuat aktivitas...'}</p>
        </div>
    `;
    ...
    try {
        ...
        saveActivityCache(allTransactions);
        ...
        if (forceRefresh) {
            showToast('✅ Aktivitas diperbarui dari server!');
        }
        ...
        container.innerHTML = `
            <div class="empty-activity">
                ...
                <button onclick="loadActivity(true)" 
...
function refreshActivity() {
    ...
    const now = Date.now();
    const lastRefreshTime = getActivityCooldown();
    ...
    setActivityCooldown(now);
    clearActivityCache();
    
    loadActivity(true).finally(() => {
        if (btn) {
            setTimeout(() => {
...
// ================================================
// ✨ ANIMASI SMOOTH SAAT SALDO MUNCUL
// ================================================

function triggerSaldoSmooth() {
    const saldoEl = document.getElementById('userSaldoAmount');
    if (!saldoEl) return;
    
    // Hapus class lama
    saldoEl.classList.remove('saldo-smooth');
    
    // Force reflow
    void saldoEl.offsetWidth;
    
    // Tambah class
    saldoEl.classList.add('saldo-smooth');
}
...
function renderLayananList(filter) {
    var list = document.getElementById('layananList');
    if (!list) return;
    var filtered = filter === 'all' ? autoSosmedServices : autoSosmedServices.filter(function(l) { return l.kategori === filter; });
    if (filtered.length === 0) {
        list.innerHTML = '<div style="text-align:center;padding:30px;color:var(--text-secondary);font-size:13px;">Tidak ada layanan di kategori ini</div>';
        return;
    }
    list.innerHTML = filtered.map(function(l) {
        var badge = '';
        if (l.isCustomComment) {
            badge = '<span style="font-size:8px;padding:2px 8px;border-radius:20px;background:rgba(139,92,246,0.15);color:#8b5cf6;font-weight:600;margin-left:6px;">Custom</span>';
        }
        return '<div class="layanan-item" data-id="' + l.id + '">' +
            '<div class="layanan-info">' +
                '<div class="layanan-name">' + l.name + badge + '</div>' +
                '<div class="layanan-desc">Min ' + l.minQuantity.toLocaleString('id-ID') + ' ' + l.unit + '</div>' +
            '</div>' +
        '</div>';
    }).join('');
    document.querySelectorAll('.layanan-item').forEach(function(item) {
...
function pilihLayanan(id) {
    selectedLayanan = autoSosmedServices.find(function(l) { return l.id === id; });
    if (!selectedLayanan) return;
    document.getElementById('autoSosmedBody').innerHTML = '';
    var customCommentHtml = '';
    if (selectedLayanan.isCustomComment) {
        customCommentHtml = `
        <div id="customCommentContainer" style="margin-bottom:16px;">
            <label style="display:block;font-size:12px;font-weight:600;color:var(--text-secondary);margin-bottom:6px;">
                <i class="ri-chat-1-line"></i> Komentar (pisahkan dengan enter)
            </label>
            <textarea id="customCommentTextarea" rows="4" class="service-target-input" placeholder="komentar 1&#10;komentar 2&#10;komentar 3" style="resize:vertical;min-height:80px;width:100%;padding:10px;background:var(--bg-secondary);border:1px solid var(--border);border-radius:12px;color:var(--text-primary);font-size:13px;"></textarea>
            <div style="display:flex;justify-content:space-between;align-items:center;margin-top:6px;">
                <p style="font-size:10px;color:var(--text-secondary);margin:0;">
                    <i class="ri-information-line"></i> Minimal ${selectedLayanan.minQuantity} komentar
                </p>
                <p style="font-size:12px;font-weight:600;color:var(--accent);margin:0;" id="commentCounter">
                    <i class="ri-chat-1-line"></i> <span id="commentCount">0</span> komentar
                </p>
            </div>
        </div>
        `;
    ...
    document.getElementById('autoSosmedBody').innerHTML = `
        <button class="step-back-btn" id="backToListBtn">
            <i class="ri-arrow-left-line"></i> Kembali
        </button>
        <div class="service-info-card" id="selectedServiceInfo">
            <div class="service-name" id="autoSelectedServiceName">${selectedLayanan.name}</div>
            <div class="service-price-info" id="autoSelectedServicePrice">Rp ${selectedLayanan.price.toLocaleString('id-ID')} / 1.000 ${selectedLayanan.unit}</div>
            <div class="service-desc" id="autoSelectedServiceDesc">${selectedLayanan.placeholder || ''}</div>
        </div>
        <div class="target-input-group">
            <label><i class="ri-link"></i> Target</label>
            <input type="text" id="autoServiceTarget" class="service-target-input" placeholder="${selectedLayanan.placeholder || ''}">
            <p class="target-hint" id="autoTargetHint">${selectedLayanan.needLink ? 'Masukkan link target' : 'Masukkan username target'}</p>
        </div>
        ${customCommentHtml}
        <div class="quantity-input-group">
            <label><i class="ri-bar-chart-line"></i> Jumlah Pesanan</label>
            <div class="min-quantity-badge">
                <div class="min-quantity-content">
                    <i class="ri-information-line"></i>
                    <span>Minimal pesan <strong id="autoMinQtyValue">${selectedLayanan.minQuantity.toLocaleString('id-ID')}</strong></span>
                </div>
            </div>
            <div class="quantity-wrapper">
                <button type="button" class="qty-decr-btn" id="autoQtyDecrBtn">-</button>
                <input type="number" id="autoServiceQuantity" class="service-quantity" value="${selectedLayanan.minQuantity}" min="${selectedLayanan.minQuantity}" step="${selectedLayanan.step || 10}">
                <button type="button" class="qty-incr-btn" id="autoQtyIncrBtn">+</button>
            </div>
        </div>
        <div class="price-breakdown">
            <div class="breakdown-item">
                <span>Harga per unit</span>
                <span id="autoPricePerUnit">Rp ${selectedLayanan.price.toLocaleString('id-ID')} / 1.000 ${selectedLayanan.unit}</span>
            </div>
            <div class="breakdown-item total">
                <span>Total Harga</span>
                <span id="autoTotalPrice">Rp ${((selectedLayanan.minQuantity / 1000) * selectedLayanan.price).toLocaleString('id-ID')}</span>
            </div>
        </div>
        <div class="modal-buttons-service">
            <button class="order-now-service-btn" id="autoOrderNowBtn">
        ...
        <div style="margin-top: 16px; text-align: center; padding-top: 12px; border-top: 1px solid var(--border);">
            <button onclick="window.location.href='layanan.html'" class="syarat-btn">
                <i class="ri-file-text-line"></i> Ketentuan Layanan
                <i class="ri-arrow-right-line"></i>
            </button>
        </div>
    `;
    document.getElementById('autoSosmedTitle').textContent = selectedLayanan.name;
    document.getElementById('backToListBtn').addEventListener('click', function() {
        selectedLayanan = null;
        document.getElementById('autoSosmedTitle').textContent = 'Pilih Layanan Otomatis';
        showAutoSosmedModal();
    });
    if (selectedLayanan.isCustomComment) {
        var textarea = document.getElementById('customCommentTextarea');
        if (textarea) {
            textarea.addEventListener('input', function() {
                ...
                if (countSpan) {
                    ...
                    var minQty = selectedLayanan.minQuantity;
                    var qty = parseInt(document.getElementById('autoServiceQuantity').value) || selectedLayanan.minQuantity;
                    if (count >= minQty && count <= qty) {
            ...
            var initialLines = textarea.value.split('\n').filter(function(l) { return l.trim() !== ''; });
            var initialCount = initialLines.length;
            var countSpan = document.getElementById('commentCount');
            if (countSpan) {
                countSpan.textContent = initialCount;
                var minQty = selectedLayanan.minQuantity;
                var qty = parseInt(document.getElementById('autoServiceQuantity').value) || selectedLayanan.minQuantity;
                if (initialCount >= minQty && initialCount <= qty) {
                    countSpan.style.color = '#10b981';
                } else if (initialCount > qty) {
                    countSpan.style.color = '#ef4444';
                } else {
                    countSpan.style.color = '#f59e0b';
                }
    ...
    document.getElementById('autoQtyDecrBtn').addEventListener('click', function() {
        var qty = parseInt(document.getElementById('autoServiceQuantity').value) || selectedLayanan.minQuantity;
        var step = selectedLayanan.step || 10;
        var minQty = selectedLayanan.minQuantity;
        if (qty - step >= minQty) {
            document.getElementById('autoServiceQuantity').value = qty - step;
            updateAutoPriceDetail();
            if (selectedLayanan.isCustomComment) {
                updateCommentCounter();
            }
        }
    });
    document.getElementById('autoQtyIncrBtn').addEventListener('click', function() {
        var qty = parseInt(document.getElementById('autoServiceQuantity').value) || selectedLayanan.minQuantity;
        var step = selectedLayanan.step || 10;
        document.getElementById('autoServiceQuantity').value = qty + step;
        updateAutoPriceDetail();
    ...
    document.getElementById('autoServiceQuantity').addEventListener('input', function() {
        updateAutoPriceDetail();
        if (selectedLayanan && selectedLayanan.isCustomComment) {
            updateCommentCounter();
        }
    });
    document.getElementById('autoOrderNowBtn').addEventListener('click', function() {
        if (!selectedLayanan) {
            showToast('Pilih layanan terlebih dahulu', true);
            return;
        }
        var target = document.getElementById('autoServiceTarget').value.trim();
        if (!target) {
            showToast('Masukkan target terlebih dahulu', true);
            return;
        }
        if (selectedLayanan.regex && !selectedLayanan.regex.test(target)) {
            showToast('Format target tidak valid', true);
            return;
        }
        var qty = parseInt(document.getElementById('autoServiceQuantity').value) || selectedLayanan.minQuantity;
        var minQty = selectedLayanan.minQuantity;
        if (qty < minQty) {
            showToast('Minimal ' + minQty.toLocaleString('id-ID') + ' ' + selectedLayanan.unit, true);
            return;
        }
        var comments = null;
        if (selectedLayanan.isCustomComment) {
            ...
            if (textarea) {
                ...
                var commentCount = lines.length;
                if (commentCount < minQty) {
                    showToast('Minimal ' + minQty + ' komentar! Saat ini: ' + commentCount, true);
                    return;
                }
                if (commentCount > qty) {
                    showToast('Komentar terlalu banyak! Maksimal ' + qty + ' komentar. Saat ini: ' + commentCount, true);
                    return;
                }
                if (commentCount !== qty) {
                    showToast('Jumlah komentar harus ' + qty + ' (sesuai quantity)! Saat ini: ' + commentCount, true);
                    return;
                }
                comments = lines.join('\n');
            }
        }
        var total = Math.round((qty / 1000) * selectedLayanan.price);
        if (comments) {
            processAutoSosmedOrder(selectedLayanan, target, qty, total, comments);
        } else {
            processAutoSosmedOrder(selectedLayanan, target, qty, total);
        }
    });
}

function updateCommentCounter() {
    if (!selectedLayanan || !selectedLayanan.isCustomComment) return;
    var textarea = document.getElementById('customCommentTextarea');
    if (!textarea) return;
    var lines = textarea.value.split('\n').filter(function(l) { return l.trim() !== ''; });
    var count = lines.length;
...
function updateAutoPriceDetail() {
    if (!selectedLayanan) return;
    var qty = parseInt(document.getElementById('autoServiceQuantity').value) || selectedLayanan.minQuantity;
    var minQty = selectedLayanan.minQuantity;
    if (qty < minQty) qty = minQty;
    var total = (qty / 1000) * selectedLayanan.price;
    document.getElementById('autoPricePerUnit').textContent = 'Rp ' + selectedLayanan.price.toLocaleString('id-ID') + ' / 1.000 ' + selectedLayanan.unit;
    document.getElementById('autoTotalPrice').textContent = 'Rp ' + total.toLocaleString('id-ID');
}

function showAutoSosmedModal() {
    var modal = document.getElementById('autoSosmedModal');
    if (!modal) return;
    var body = document.getElementById('autoSosmedBody');
    body.innerHTML = '';
    body.innerHTML = `
        <div class="kategori-select-wrapper">
            <label><i class="ri-apps-line"></i> Pilih Kategori</label>
        ...
        <div class="layanan-list" id="layananList"></div>
    `;
    document.getElementById('autoSosmedTitle').textContent = 'Pilih Layanan Otomatis';
    selectedLayanan = null;
    currentFilter = 'all';
    renderLayananList('all');
    document.getElementById('kategoriSelect').addEventListener('change', function() {
        var filter = this.value;
        currentFilter = filter;
        renderLayananList(filter);
    });
    modal.classList.add('active');
}
...
document.addEventListener('DOMContentLoaded', function() {
    var closeModal = document.getElementById('closeAutoSosmedModal');
    var modal = document.getElementById('autoSosmedModal');
    if (closeModal) closeModal.addEventListener('click', closeAutoSosmedModal);
    if (modal) {
        modal.addEventListener('click', function(e) {
            if (e.target === modal) closeAutoSosmedModal();
        });
    }
});
